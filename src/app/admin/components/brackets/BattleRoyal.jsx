    ...
    <div className="mb-8">
      <div className="flex justify-between items-center">
        ...
        >
          ...
          <div
            className={`relative z-10 flex items-center justify-center w-7 h-7 mr-3 rounded-full ${
              isAdminModalOpen ? 'bg-white/10' : 'bg-primary/20'
          ...
          <div
            className={`absolute top-0 right-0 border-t-8 border-r-8 ${
              isAdminModalOpen ? 'border-red-400' : 'border-primary/60'
